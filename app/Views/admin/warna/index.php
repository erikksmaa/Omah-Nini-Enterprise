    ...
    <div class="d-flex flex-wrap align-items-center justify-content-between gap-2 mb-4">
        <div>
            <h4 class="fw-bold mb-0">
                <i class="bi bi-droplet-half text-primary me-2"></i>Master Warna
            </h4>
            <p class="text-muted small mb-0 mt-1">Kelola data warna produk</p>
        </div>
        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addModal">
            <i class="bi bi-plus-circle me-1"></i> Tambah Warna
        </button>
    </div>
                            ...
                            <?php else: ?>
                                <tr>
                                    <td colspan="3" class="text-center py-5 text-muted">
                                        ...
                                        <?= !empty($keyword)
                                            ? 'Warna "<strong>' . esc($keyword) . '</strong>" tidak ditemukan'
                ...
                <?php if (isset($pager) && $pager->getTotal() > 0): ?>
                    <div class="d-flex flex-wrap justify-content-between align-items-center gap-2 mt-3 pt-3 border-top">
                        <small class="text-muted">
                            Menampilkan <strong><?= count($warna) ?></strong>
        ...
        <div class="modal-content border-0 shadow">
            ...
            <div class="modal-header bg-primary text-white rounded-top">
                <h5 class="modal-title fw-semibold" id="addModalLabel">
                    <i class="bi bi-plus-circle me-2"></i>Tambah Warna Baru
                </h5>
                ...
                <div class="modal-body p-4">
                    <div class="mb-0">
                        ...
                        <input type="text" name="nama_warna" class="form-control"
                            placeholder="Contoh: Putih, Sogan, Toska..."
                            required>
                        <div class="form-text text-muted small mt-1">
                            <i class="bi bi-info-circle me-1"></i>Contoh: Putih, Biru, Merah, Sogan, Toska, dll
                        </div>
                    </div>
                </div>
        ...
        <div class="modal-content border-0 shadow">
            ...
            <div class="modal-header bg-warning rounded-top">
                <h5 class="modal-title fw-semibold" id="editModalLabel">
                    <i class="bi bi-pencil-square me-2"></i>Edit Warna
                </h5>
            ...
            <form id="editForm" method="POST">
                ...
                <div class="modal-body p-4">
                    <div class="mb-0">
                        ...
                        <input type="text" name="nama_warna" id="edit_nama_warna"
...
<script>
    ...
    document.querySelectorAll('.btn-edit').forEach(btn => {
        btn.addEventListener('click', function () {
            document.getElementById('edit_nama_warna').value = this.dataset.nama_warna ?? '';
            document.getElementById('editForm').action =
                `<?= base_url('admin/warna/update') ?>/${this.dataset.id}`;
    ...
    document.querySelectorAll('.btn-delete').forEach(btn => {
        btn.addEventListener('click', function () {
            ...
            Swal.fire({
                title: 'Hapus Warna?',
                html: `Warna <strong>${nama_warna}</strong> akan dihapus permanen.`,
                icon: 'warning',
