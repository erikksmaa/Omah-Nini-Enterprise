    ...
    <div class="sidebar-wrapper active">
        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                <?php if ($role === 'admin'): ?>
                    <li
                        class="sidebar-item has-sub <?= (in_array(uri_string(), ['admin/kategori', 'admin/supplier', 'admin/produk'])) ? 'active' : '' ?>">
                        <a href="#" class='sidebar-link'>
                            <i class="bi bi-stack"></i>
                            <span>Master Data</span>
                        </a>
                        <ul
                            class="submenu <?= (in_array(uri_string(), ['admin/kategori', 'admin/supplier', 'admin/produk'])) ? 'active' : '' ?>">
                            <li class="submenu-item <?= (uri_string() == 'admin/user') ? 'active' : '' ?>">
                                <a href="<?= base_url('admin/user') ?>" class="submenu-link">Manajemen User</a>
                            </li>
                            <li class="submenu-item <?= (uri_string() == 'admin/kategori') ? 'active' : '' ?>">
                                <a href="<?= base_url('admin/kategori') ?>" class="submenu-link">Data Kategori</a>
                            </li>
                            <li class="submenu-item <?= (uri_string() == 'admin/supplier') ? 'active' : '' ?>">
                                <a href="<?= base_url('admin/supplier') ?>" class="submenu-link">Data Supplier</a>
                            </li>
                            <li class="submenu-item <?= (uri_string() == 'admin/produk') ? 'active' : '' ?>">
                                <a href="<?= base_url('admin/produk') ?>" class="submenu-link">Data Produk</a>
                            </li>
                        </ul>
                    </li>
                    </li>
