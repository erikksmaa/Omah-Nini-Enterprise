                                    ...
                                    <?php else: ?>
                                        <tr>
                                            <td colspan="8" class="text-center py-4">
                                                ...
                                                <p class="text-muted mt-2 mb-0">Tidak ada data penjualan</p>
                                            </td>
                                        </tr>
                                    <?php endif; ?>
                                </tbody>
                                ...
                                <div class="card mb-2 shadow-sm">
                                    <div class="card-body p-2">
                                        ...
                                        <div class="d-flex justify-content-between align-items-start mb-2">
                                            <div>
                                                <span class="badge bg-primary"><?= esc($trx['no_invoice']) ?></span>
                                                <small
                                                    class="text-muted ms-2"><?= date('d/m/Y H:i', strtotime($trx['tanggal_transaksi'])) ?></small>
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-2">
                                            <div class="text-muted small mb-1">
                                                <i class="bi bi-box-seam"></i> Detail Barang (<?= $trx['total_items'] ?? 0 ?>
                                                item):
                                            </div>
                                            <?php if (!empty($trx['items'])): ?>
                                        ...
                                        <?php if (!empty($trx['catatan'])): ?>
                                            <div class="mt-2">
                                                <small class="text-muted">
                                                    <i class="bi bi-chat-text"></i> Catatan: <?= esc($trx['catatan']) ?>
                                                </small>
                                            </div>
                                        <?php endif; ?>
                                    </div>
