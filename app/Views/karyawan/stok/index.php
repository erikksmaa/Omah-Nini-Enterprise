                    ...
                    <div class="row g-2">
                        <div class="col-md-6">
                            <div class="alert alert-success mb-0">
                                ...
                                <strong>Total Produk:</strong> <?= number_format($total_produk ?? 0) ?>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="alert alert-info mb-0">
                                <i class="bi bi-calculator me-1"></i>
                                <strong>Total Stok:</strong> <?= number_format($total_stok ?? 0) ?> Potong
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <form method="get" class="row g-2">
                                ...
                                <div class="col-md-4">
                                    <select name="status" class="form-select form-select-sm"
                                        ...
                                        <option value="aman" <?= ($selectedStatus ?? '') == 'aman' ? 'selected' : '' ?>>✅
                                            Stok Aman</option>
                                        <option value="menipis" <?= ($selectedStatus ?? '') == 'menipis' ? 'selected' : '' ?>>⚠️ Stok Menipis</option>
                                        <option value="habis" <?= ($selectedStatus ?? '') == 'habis' ? 'selected' : '' ?>>❌
                                            Stok Habis</option>
                                    </select>
                                </div>
                                <div class="col-md-2 d-flex align-items-end">
                                    <a href="<?= base_url('karyawan/stok') ?>"
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <div class="btn-group btn-group-sm">
                                                        <a href="<?= base_url('karyawan/stok/detail/' . $row['id']) ?>"
                                                            class="btn btn-outline-info" title="Detail">
                                                            <i class="bi bi-eye"></i>
                                                        </a>
                                                        <a href="<?= base_url('karyawan/stok/opname/' . $row['id']) ?>"
                                                            class="btn btn-outline-warning" title="Opname">
